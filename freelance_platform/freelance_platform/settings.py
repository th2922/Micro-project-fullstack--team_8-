...
SECRET_KEY = 'django-insecure-^*osn1%_81s0ye38rg@(s6wux-iv!(-!)^h3xw9p7ia-e*-sfw'
...
# DEFAULT_FROM_EMAIL = 'no-reply@freelancehub.local'

# Option 2: Gmail SMTP (Recommended - sends real emails)
# Steps to setup:
# 1. Enable 2-Factor Authentication on your Google Account
# 2. Go to https://myaccount.google.com/apppasswords
# 3. Select "Mail" and "Windows Computer" (or your device)
# 4. Copy the 16-character app password
# 5. Replace 'your-gmail@gmail.com' and 'app-password' below
...
EMAIL_HOST_PASSWORD = 'xxxx xxxx xxxx xxxx'  # Replace with your 16-char app password
